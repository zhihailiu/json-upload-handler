# Alfresco Java Event API - JSON Document Upload Event Handler
...
This is based on the sample [event-api-handlers](https://github.com/Alfresco/alfresco-java-sdk/tree/develop/samples/event-api-handlers)
...
#### need rendition definition json
