...
public class JsonUploadEventsHandlerApplication {

    private static final Logger LOGGER = LoggerFactory.getLogger(JsonUploadEventsHandlerApplication.class);

    public static void main(final String[] args) {
        SpringApplication.run(JsonUploadEventsHandlerApplication.class, args);
    }
